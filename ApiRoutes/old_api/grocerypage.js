...
router.get('/recommended', (req,res) => {
        ...
        mysqlConnectionfidsbay.query(sql_Algorithm_pattern,function (err,result_1,fields) {
            ...
            if ((result_1[0].recommended_algorithm_pattern=='products.id') && (result_1[0].recommended_algorithm_pattern_order=='DESC')) {
                ...
                try {
                    ...
                    members.userstatus, members.likes, members.phoneno  FROM products INNER JOIN members ON products.ownerid=members.id WHERE producttype='grocery' ORDER BY products.id DESC";
                ...
                try {
                    ...
                    products.productprice, products.productpriceDisplay, products.preparationtime, products.location, products.city, products.country, products.ownerid,\
                    products.dateadded, products.productlikes, products.liked_by_array, members.username, members.profilephoto,\
                    members.userstatus, members.likes, members.phoneno  FROM products INNER JOIN members ON products.ownerid=members.id WHERE producttype='grocery' ORDER BY products.id ASC";
                    mysqlConnectionfidsbay.query(sqlconst,function (err,rows,fields) {
                        res.send(rows);
                    }); //End of product mysql statement
                ...
                try {
                    ...
                    products.productprice, products.productpriceDisplay, products.preparationtime, products.location, products.city, products.country, products.ownerid,\
                    products.dateadded, products.productlikes, products.liked_by_array, members.username, members.profilephoto,\
                    members.userstatus, members.likes, members.phoneno  FROM products INNER JOIN members ON products.ownerid=members.id WHERE producttype='grocery' ORDER BY products.productlikes DESC";
                    mysqlConnectionfidsbay.query(sqlconst,function (err,rows,fields) {
                        res.send(rows);
                    }); //End of product mysql statement
                ...
                try {
                    ...
                    products.productprice, products.productpriceDisplay, products.preparationtime, products.location, products.city, products.country, products.ownerid,\
                    products.dateadded, products.productlikes, products.liked_by_array, members.username, members.profilephoto,\
                    members.userstatus, members.likes, members.phoneno  FROM products INNER JOIN members ON products.ownerid=members.id WHERE producttype='grocery' ORDER BY products.ownerid ASC";
                    mysqlConnectionfidsbay.query(sqlconst,function (err,rows,fields) {
                        res.send(rows);
                    }); //End of product mysql statement
                ...
                try {
                    ...
                    products.productprice, products.productpriceDisplay, products.preparationtime, products.location, products.city, products.country, products.ownerid,\
                    products.dateadded, products.productlikes, products.liked_by_array, members.username, members.profilephoto,\
                    members.userstatus, members.likes, members.phoneno  FROM products INNER JOIN members ON products.ownerid=members.id WHERE producttype='grocery' ORDER BY products.ownerid DESC";
                    mysqlConnectionfidsbay.query(sqlconst,function (err,rows,fields) {
                        res.send(rows);
                    }); //End of product mysql statement
                ...
                try {
                    ...
                    products.productprice, products.productpriceDisplay, products.preparationtime, products.location, products.city, products.country, products.ownerid,\
                    products.dateadded, products.productlikes, products.liked_by_array, members.username, members.profilephoto,\
                    members.userstatus, members.likes, members.phoneno  FROM products INNER JOIN members ON products.ownerid=members.id WHERE producttype='grocery' ORDER BY products.productprice ASC";
                    mysqlConnectionfidsbay.query(sqlconst,function (err,rows,fields) {
                        res.send(rows);
                    }); //End of product mysql statement
                ...
                try {
                    ...
                    products.productprice, products.productpriceDisplay, products.preparationtime, products.location, products.city, products.country, products.ownerid,\
                    products.dateadded, products.productlikes, products.liked_by_array, members.username, members.profilephoto,\
                    members.userstatus, members.likes, members.phoneno  FROM products INNER JOIN members ON products.ownerid=members.id WHERE producttype='grocery' ORDER BY products.productprice DESC";
                    mysqlConnectionfidsbay.query(sqlconst,function (err,rows,fields) {
                        res.send(rows);
                    }); //End of product mysql statement
    ...
    // get suggested suppliers
    // get suggested suppliers
    router.get('/suggestedsuppliers', (req,res) => {


        try {
            const sql_suggested = "SELECT accountclass, business_category, city, username, userstatus, profilephoto, onlinestatus, fullname FROM members WHERE accounttype='business' AND productnumber!=0 AND business_category='Supermarket' ORDER BY points DESC LIMIT 30";
